...
FraudData<-read.csv(url('https://www.dropbox.com/home/Deepti%20-%20Blood%20Donation%20Modeling/Fraud%20Transaction%20Detection/Final%20Project%20Content'),header=T,row.names=NULL)
...
ui<-fluidPage(theme = shinytheme("darkly"),
                titlePanel(column(8, offset = 4, tags$img(src = "https://www.thehaguesecuritydelta.com/media/com_hsd/partner/502/logo/logo-anti-fraud-company.png", width = 250))),
                column(6, offset = 3 , tags$hr(style="border: solid 1.5px gold")),
  tags$head(
    tags$style(HTML("body{
                    background-image: url(https://arconnet.com/images/Demo/case-studies/finance.jpg);
                    }"))),
